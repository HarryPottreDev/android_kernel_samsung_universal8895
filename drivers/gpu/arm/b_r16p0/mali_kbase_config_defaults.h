 ...
 */
#define DEFAULT_PM_GPU_POWEROFF_TICK_NS (4000000) /* 400us */

/**
 * Power Manager number of ticks before shader cores are powered off
 */
#define DEFAULT_PM_POWEROFF_TICK_SHADER (20) /* 400-800us */

/**
 * Default scheduling tick granuality
 */
#define DEFAULT_JS_SCHEDULING_PERIOD_NS    (20000000u) /* 100ms */
 ...
 */
#define DEFAULT_JS_CTX_TIMESLICE_NS (20000000) /* 50ms */
